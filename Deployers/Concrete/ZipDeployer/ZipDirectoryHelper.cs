...
{
    public class ZipDirectoryHelper : IDirectoryHelper
    {
        ...
        public ZipDirectoryHelper()
        { }
        public ZipDirectoryHelper(string zipPath)
        {
            string reg = @"(.*?)[/\\](\w+\.zip)$";
        ...
        public ZipDirectoryHelper(string zipPath, string zipName)
        { 
